...
export async function POST(request: Request) {
  try {
    ...
    const profileRow: Record<string, unknown> = {
      ...
      grew_up_in: body.grew_up_in ?? null,
      ...
      annual_income_min: body.annual_income_min ?? null,
      annual_income_max: body.annual_income_max ?? null,
      ...
      family_type: body.family_type ?? null,
      family_values: body.family_values ?? null,
      family_status: body.family_status ?? null,
